<template>
  <div>
    ...
    <el-dialog title="上传凭证" :visible.sync="dialogFormVisible">
      <el-upload
        class="upload-demo"
        action=" http://47.94.84.99:5588/file/upload"
    ...
    <el-dialog style="width:1000px;margin-left:250px" title="凭证" :visible.sync="dialogFormVisible1">
      <div class="line"></div>
      <el-image style="width:300px;height:300px;margin-left:80px;margin-top:28px" :src="'http://47.94.84.99:8686/group1/'+this.transferAccounts"></el-image>   
    </el-dialog>
    <!--查看凭证详情-->
  </div>
</template>
